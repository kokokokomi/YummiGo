...
const showPageList = async () => {
  ...
  const { data: res } = await getSetmealPageListAPI(params)
  console.log('套餐列表')
...
<template>
  <el-card>
    <div class="horizontal">
      <el-input size="large" class="input" v-model="pageData.name" placeholder="セット名" @keyup.enter="onSearch" />
    ...
    <el-table ref="multiTableRef" :data="setmealList" stripe @selection-change="handleSelectionChange">
      ...
      <el-table-column label="詳細" width="150px" align="center">
        <template #default="scope">
      ...
      <el-table-column prop="categoryId" label="カテゴリ" width="120px" align="center">
